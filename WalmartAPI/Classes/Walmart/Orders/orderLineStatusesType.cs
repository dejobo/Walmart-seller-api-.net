...
namespace WalmartAPI.Classes.Walmart.Orders
{
    ...
    public partial class orderLineStatusesType
    {
        ...
        private WalmartAPI.Classes.Walmart.Orders.orderLineStatusType[] orderLineStatusField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("orderLineStatus")]
        public WalmartAPI.Classes.Walmart.Orders.orderLineStatusType[] orderLineStatus
        {
            get
            {
